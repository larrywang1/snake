...
func inspect():
	if manual:
		...
		manual_string = "X"
	InspectManager.add_inspect(self, "BD-L-AA", "Fires an clockwise rotating laser", {"attack": damage, "health": health, "max_cd" : cooldown, "current_cd" : current_cooldown, "manual" : manual_string}, manual, activated, upgraded, unupgraded, attributes)
