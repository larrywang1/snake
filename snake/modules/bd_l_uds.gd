...
func inspect():
	if manual:
		...
		manual_string = "X"
	InspectManager.add_inspect(self, "BD-L-TBS", "Fires a piercing laser upwards and downwards simultaneously", {"attack": damage, "health": health, "max_cd" : cooldown, "current_cd" : current_cooldown, "manual" : manual_string}, manual, activated, upgraded, unupgraded, attributes)
